...
fred_right_1
    ...
    .byte %00111111, %00000000     ; ..######........
    .byte %00111111, %00000000     ; ..######........
    .byte %01111011, %10000000     ; .####.###.......
    .byte %01111101, %10000000     ; .#####.##.......
    .byte %00011110, %00000000     ; ...####.........
    .byte %00111011, %00000000     ; ..###.##........
    .byte %00110111, %00000000     ; ..##.###........
    ...
    .byte %00000011, %01111011     ; ......##.####.##
    .byte %00000000, %01111100     ; .........#####..
    .byte %00000000, %11101101     ; ........###.##.#
    .byte %00000001, %10000111     ; .......##....###
    .byte %00000001, %11000010     ; .......###....#.

fred_left_1:
    .byte %00011100, %00000000     ; ...###..........
    .byte %00011110, %00000000     ; ...####.........
    .byte %01111111, %00000000     ; .#######........
    .byte %00010111, %11000000     ; ...#.#####......
    .byte %00111111, %00000000     ; ..######........
    .byte %00011110, %00000000     ; ...####.........
    .byte %00001100, %00000000     ; ....##..........
    .byte %00011110, %00000000     ; ...####.........
    ...
    .byte %10110111, %00000000     ; #.##.###........
    .byte %11100001, %10000000     ; ###....##.......
    .byte %01000011, %10000000     ; .#....###.......

    .byte %00000111, %00000000     ; .....###........
    .byte %00000111, %10000000     ; .....####.......
    .byte %00011111, %11000000     ; ...#######......
    .byte %00000101, %11110000     ; .....#.#####....
    .byte %00001111, %11000000     ; ....######......
    .byte %00000111, %10000000     ; .....####.......
    .byte %00000011, %00000000     ; ......##........
    .byte %00000111, %10000000     ; .....####.......
    .byte %00001111, %11000000     ; ....######......
    .byte %00001111, %11000000     ; ....######......
    .byte %00011101, %11100000     ; ...###.####.....
    .byte %00011011, %11100000     ; ...##.#####.....
    .byte %00000111, %10000000     ; .....####.......
    .byte %00001101, %11000000     ; ....##.###......
    .byte %00001110, %11000000     ; ....###.##......
    .byte %00011101, %11000000     ; ...###.###......

    .byte %00000001, %11000000     ; .......###......
    .byte %00000001, %11100000     ; .......####.....
    .byte %00000111, %11110000     ; .....#######....
    .byte %00000001, %01111100     ; .......#.#####..
    .byte %00000011, %11110000     ; ......######....
    .byte %00000001, %11100000     ; .......####.....
    .byte %00000000, %11000000     ; ........##......
    .byte %00000001, %11100000     ; .......####.....
    ...
    .byte %00000000, %11111100     ; ........######..
    .byte %00000000, %11111100     ; ........######..
    .byte %00000001, %11011110     ; .......###.####.
    .byte %00000001, %10111110     ; .......##.#####.
    .byte %00000000, %01111000     ; .........####...
    .byte %00000000, %11011100     ; ........##.###..
    .byte %00000000, %11101100     ; ........###.##..
...
ambulance_1:
    ...
    .byte %10000000, %00000000     ; #...............
    .byte %10000000, %00000000     ; #...............
    .byte %10001100, %11001100     ; #...##..##..##..
    .byte %10001100, %11001100     ; #...##..##..##..
    .byte %10110011, %00110011     ; #.##..##..##..##
    .byte %10110011, %00110011     ; #.##..##..##..##
    .byte %10000000, %00000000     ; #...............
    .byte %01000011, %00000000     ; .#....##........
    .byte %00110101, %10111111     ; ..##.#.##.######
    .byte %00000111, %10000000     ; .....####.......
    .byte %00000011, %00000000     ; ......##........
    ...
    .byte %00010101, %01010101     ; ...#.#.#.#.#.#.#
    .byte %00101010, %10101010     ; ..#.#.#.#.#.#.#.
    .byte %00100000, %00000000     ; ..#.............
    .byte %00100000, %00000000     ; ..#.............
    .byte %00100011, %00110011     ; ..#...##..##..##
    .byte %00100011, %00110011     ; ..#...##..##..##
    .byte %00101100, %11001100     ; ..#.##..##..##..
    .byte %00101100, %11001100     ; ..#.##..##..##..
    .byte %00100000, %00000000     ; ..#.............
    .byte %00010000, %11000000     ; ...#....##......
    .byte %00001101, %10101111     ; ....##.##.#.####
    .byte %00000001, %11100000     ; .......####.....
    .byte %00000000, %11000000     ; ........##......
    ...
    .byte %00000011, %11111111     ; ......##########
    .byte %00000101, %01010101     ; .....#.#.#.#.#.#
    .byte %00001010, %10101010     ; ....#.#.#.#.#.#.
    .byte %00001000, %00000000     ; ....#...........
    .byte %00001000, %00000000     ; ....#...........
    .byte %00001000, %11001100     ; ....#...##..##..
    .byte %00001000, %11001100     ; ....#...##..##..
    .byte %00001011, %00110011     ; ....#.##..##..##
    .byte %00001011, %00110011     ; ....#.##..##..##
    .byte %00001000, %00000000     ; ....#...........
    .byte %00000100, %00110000     ; .....#....##....
    .byte %00000011, %01111011     ; ......##.####.##
    .byte %00000000, %01101000     ; .........##.#...
    .byte %00000000, %00110000     ; ..........##....
    ...
    .byte %00000010, %10101010     ; ......#.#.#.#.#.
    .byte %00000010, %00000000     ; ......#.........
    .byte %00000010, %00000000     ; ......#.........
    .byte %00000010, %00110011     ; ......#...##..##
    .byte %00000010, %00110011     ; ......#...##..##
    .byte %00000010, %11001100     ; ......#.##..##..
    .byte %00000010, %11001100     ; ......#.##..##..
    .byte %00000010, %00000000     ; ......#.........
    .byte %00000001, %00001100     ; .......#....##..
    .byte %00000000, %11011110     ; ........##.####.
...
ambulance_2:
    ...
    .byte %00000001, %10000000     ; .......##.......
    .byte %00000100, %01000000     ; .....#...#......
    .byte %11001110, %01000000     ; ##..###..#......
    .byte %11000100, %01000000     ; ##...#...#......
    .byte %00000000, %01000000     ; .........#......
    .byte %00001100, %01000000     ; ....##...#......
    .byte %11011110, %10000000     ; ##.####.#.......
    ...
    .byte %00001110, %10000000     ; ....###.#.......
    .byte %11000000, %01100000     ; ##.......##.....
    .byte %11000001, %00010000     ; ##.....#...#....
    .byte %00110011, %10010000     ; ..##..###..#....
    .byte %00110001, %00010000     ; ..##...#...#....
    .byte %00000000, %00010000     ; ...........#....
    .byte %00000011, %00010000     ; ......##...#....
    .byte %11110111, %10100000     ; ####.####.#.....
    ...
    .byte %00000000, %00000000     ; ................
    .byte %11111110, %00000000     ; #######.........
    .byte %01010001, %00000000     ; .#.#...#........
    .byte %10101010, %10000000     ; #.#.#.#.#.......
    .byte %00000011, %01000000     ; ......##.#......
    .byte %00000011, %10100000     ; ......###.#.....
    .byte %00110000, %00011000     ; ..##.......##...
    .byte %00110000, %01000100     ; ..##.....#...#..
    .byte %11001100, %11100100     ; ##..##..###..#..
    .byte %11001100, %01000100     ; ##..##...#...#..
